...
namespace gl3::engine::ecs
{
    ...
    private:
        ...
        static std::vector<b2ShapeId> createSensors(const GameObject& player, const b2BodyId playerBody)
        {
            ...
            b2Polygon groundBox;
            groundBox = b2MakeOffsetBox(halfWidth * 0.8f, 0.01f,
                                        {0.f, 0.f - halfHeight},
                                        b2MakeRot(0.0f));
            ...
            b2Polygon topBox;
            topBox = b2MakeOffsetBox(halfWidth * 0.8f, 0.01f,
                                        {0.f, 0.f + halfHeight},
                                        b2MakeRot(0.0f));
            ...
            b2Polygon rightBox;
            rightBox = b2MakeOffsetBox(0.01f, halfHeight * 0.5f,
                                       {0.f + halfWidth - 0.01f, 0.f},
                                       b2MakeRot(0.0f));
